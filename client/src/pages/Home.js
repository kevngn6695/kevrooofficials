...
function Home(props) {
  ...
  const skillbars = [
    {
      classNameCard: "card html",
      classNameCircle: "circle html",
      classNameBar: "bar html",
      classNamePercent: "percent html",
      percentage: "0%",
      classNameText: "skilltext html",
      skillName: "HTML",
    },
    {
      classNameCard: "card css",
      classNameCircle: "circle css",
      classNameBar: "bar css",
      classNamePercent: "percent css",
      percentage: "0%",
      classNameText: "skilltext css",
      skillName: "CSS",
    },
    {
      classNameCard: "card js",
      classNameCircle: "circle js",
      classNameBar: "bar js",
      classNamePercent: "percent js",
      percentage: "12%",
      classNameText: "skilltext js",
      skillName: "Javascript",
    },
    {
      classNameCard: "card react",
      classNameCircle: "circle react",
      classNameBar: "bar react",
      classNamePercent: "percent react",
      percentage: "0%",
      classNameText: "skilltext react",
      skillName: "React",
    },
  ];
